...
import static org.elasticsearch.index.mapper.CompletionFieldMapper2x.Fields.ANALYZER;
...
public class TestFilm {
     ...
     */
    @Test
    public void testIndexAnalyze() throws Exception{
        XContentBuilder mapping = XContentFactory.jsonBuilder()
                .startObject()
                .startObject("properties")
                .startObject("m_id").field("type","keyword").endObject()
                .startObject("poi_index").field("type","integer").endObject()
                .startObject("poi_title").field("type","text").field("analyzer","smartcn").endObject()
                .startObject("poi_address").field("type","text").field("analyzer","smartcn").endObject()
                .startObject("poi_tags").field("type","text").field("analyzer","smartcn").endObject()
                .startObject("poi_phone").field("type","text").field("analyzer","smartcn").endObject()
